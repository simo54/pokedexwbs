    ...
    <div className="container">
      ...
      {pokelist && pokelist.length ? (
        <form onSubmit={textSubmit}>
          ...
          {toggle === true ? (
            <Effectdex
              name={pokeSearch[0].name}
              img={pokeSearch[0].img}
              number={pokeSearch[0].id}
          ...
          <div className="container mt-3 d-flex justify-content-center">
            <img
              id="pikaHead"
              alt="pikachu"
              src="https://www.freepngimg.com/thumb/pokemon/37475-6-pikachu-transparent-image.png"
              width="50"
              height="50"
            />
          </div>
      ...
      <div className="row m-auto mb-2">
        ...
        {pokelist
          ? pokelist.map((element, index) => (
              <div
                className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-4"
                key={index}
              >
                <PokeCard
                  element={element}
